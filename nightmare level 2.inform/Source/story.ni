...
the hospital reception is northeast of street to hospital .
 ...
 Room 304 is west of the hospital reception.
	the description of Room 304 is "Your dying sister lays on the bed. She wants chocolate"
...
Instead of going north in the energysource:
	if the player carries the chocolate, say "something happen";
	otherwise say "nothing is haoening.";
